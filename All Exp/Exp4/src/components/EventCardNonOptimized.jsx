...
const EventCardNonOptimized = ({ event, onDragStart, onDelete }) => {
  // Increment child render counter on EVERY render
  incrementChildRender();
  console.log(`🐢 Non‑Optimized: EventCard "${event.title}" rendering (NO memo)`);
...
export default EventCardNonOptimized;